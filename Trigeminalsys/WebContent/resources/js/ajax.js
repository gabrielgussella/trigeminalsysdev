//Criando o objeto genérico TRIGEMINAL
TRIGEMINAL = new Object();

//Criando o sub-objeto ajax do objeto TRIGEMINAL.
TRIGEMINAL.ajax = new Object();
...
TRIGEMINAL.ajax.post = function(cfg){
...
TRIGEMINAL.ajax.get = function(cfg){
	var def = new ajaxRequestDefault();
	cfg.type = "GET";
	cfg = verifyObjectData(cfg);
	var config = $.extend(def, cfg);
